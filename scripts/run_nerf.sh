...
CUDA_VISIBLE_DEVICES=1 python main_nerf.py /data5/wuzhongkai/data/dreamfusion_data/llff/nerf_llff_data/flower --workspace trial_nerf_flower_ncr_debug -O --type llff --dt_gamma 0